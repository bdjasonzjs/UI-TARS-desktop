...
// Utilities
import { getLogger, LogLevel } from '@ui-tars-test/tarko-agent';
```
...
interface AgentOptions {
  // Core Configuration
  id?: string;                    // Unique agent ID (default: "@ui-tars-test/tarko-agent")
...
```typescript
// From examples/tool-calls/basic.ts
import { Agent, Tool, z, LogLevel } from '@ui-tars-test/tarko-agent';
