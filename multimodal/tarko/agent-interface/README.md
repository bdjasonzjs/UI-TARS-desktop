...
```typescript
import { IAgent, AgentOptions } from '@ui-tars-test/tarko-agent-interface';
...
```typescript
import { Tool } from '@ui-tars-test/tarko-agent-interface';
import { z } from 'zod';
...
declare module '@ui-tars-test/tarko-agent-interface' {
